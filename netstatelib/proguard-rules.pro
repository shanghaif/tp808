...
-keep class net.rayton.phonestatelib.MyPhoneStateListener$*{*;}
#-keep class net.rayton.phonestatelib.MyPhoneStateListener$*{*;}
-keep class net.rayton.netstatelib.NetWorkMonitor{*;}
-keep class net.rayton.netstatelib.NetWorkState{*;}