//
// Created by Android on 2020/6/27.
//
#include <cstdio>
#include <jni.h>
#include <string>
...
Java_net_rayton_videolib_YUVUtils_init(JNIEnv *env, jclass type, jint width, jint height,
...
extern "C"
JNIEXPORT void JNICALL
Java_net_rayton_videolib_YUVUtils_compressYUV(JNIEnv *env, jclass type, jbyteArray src_, jint width,
        jint height, jbyteArray dst_, jint dst_width,
jint dst_height, jint mode, jint degree,
        jboolean isMirror) {
...
extern "C"
JNIEXPORT void JNICALL
Java_net_rayton_videolib_YUVUtils_cropYUV(JNIEnv *env, jclass type, jbyteArray src_, jint width,
                                          jint height, jbyteArray dst_, jint dst_width,
...
extern "C"
JNIEXPORT void JNICALL
Java_net_rayton_videolib_YUVUtils_yuvI420ToNV21(JNIEnv *env, jclass type, jbyteArray i420Src,
