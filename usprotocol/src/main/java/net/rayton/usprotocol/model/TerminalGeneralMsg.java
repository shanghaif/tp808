package net.rayton.usprotocol.model;


import net.rayton.usprotocol.ObjectHeader;
import net.rayton.usprotocol.model.info.TerminalGeneralInfo;
import net.rayton.usprotocol.utils.BitOperator;
 ...
 *  终端通用回复
 * */
public class TerminalGeneralMsg extends ObjectHeader {
...
//    }
    ...
    @Override
    public ObjectHeader inflatePackageBody(byte[] datas) throws NullPointerException {
        return null;
    }
