...
import cn.erayton.cameratest.ui.FocusView;
import cn.erayton.cameratest.utils.CoordinateTransformer;
...
public class FocusOverlayManager {
    ...
    public MeteringRectangle getFocusArea(float x, float y, boolean isFocusArea){
        ...
        if (isFocusArea){
            ...
            return calcTapAreaForCamera2(mPreviewRect.height() /4, 1000) ;
        }
    }
