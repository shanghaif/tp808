...
public class DualCameraUI extends CameraBaseUI implements GestureTextureView.GestureListener {
    ...
    public DualCameraUI(Context context, Handler mainHandler, CameraUiEvent event) {
        super(event);
        mRootView = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.module_dual_camera_layout, null);
    ...
    public void updateUISize(int width, int height){
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(auxW, auxH) ;
        mAuxPreviewTexture.setLayoutParams(params);
    }
